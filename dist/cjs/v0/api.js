...
const EnrollmentsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        enrollmentsRetrieve: (id_1, ...args_1) => __awaiter(this, [id_1, ...args_1], void 0, function* (id, options = {}) {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('enrollmentsRetrieve', 'id', id);
    ...
    return {
        ...
        enrollmentsRetrieve(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['EnrollmentsApi.enrollmentsRetrieve']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        userEnrollmentsListV3(exclude_b2b, org_id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['EnrollmentsApi.userEnrollmentsListV3']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
...
class EnrollmentsApi extends base_1.BaseAPI {
     ...
     */
    enrollmentsRetrieve(requestParameters, options) {
        return (0, exports.EnrollmentsApiFp)(this.configuration).enrollmentsRetrieve(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * API view set for user enrollments
     * @param {EnrollmentsApiEnrollmentsUpdateRequest} requestParameters Request parameters.
     ...
     */
    userEnrollmentsListV3(requestParameters = {}, options) {
        return (0, exports.EnrollmentsApiFp)(this.configuration).userEnrollmentsListV3(requestParameters.exclude_b2b, requestParameters.org_id, options).then((request) => request(this.axios, this.basePath));
    }
}
...
const ProgramEnrollmentsApiAxiosParamCreator = function (configuration) {
    return {
        ...
        v3ProgramEnrollmentsCreate: (V3ProgramEnrollmentRequestRequest_1, ...args_1) => __awaiter(this, [V3ProgramEnrollmentRequestRequest_1, ...args_1], void 0, function* (V3ProgramEnrollmentRequestRequest, options = {}) {
            ...
            (0, common_1.assertParamExists)('v3ProgramEnrollmentsCreate', 'V3ProgramEnrollmentRequestRequest', V3ProgramEnrollmentRequestRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(V3ProgramEnrollmentRequestRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        v3ProgramEnrollmentsDestroy: (program_id_1, ...args_1) => __awaiter(this, [program_id_1, ...args_1], void 0, function* (program_id, options = {}) {
            ...
            (0, common_1.assertParamExists)('v3ProgramEnrollmentsDestroy', 'program_id', program_id);
    ...
    return {
        ...
        v3ProgramEnrollmentsCreate(V3ProgramEnrollmentRequestRequest, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['ProgramEnrollmentsApi.v3ProgramEnrollmentsCreate']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        v3ProgramEnrollmentsDestroy(program_id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['ProgramEnrollmentsApi.v3ProgramEnrollmentsDestroy']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
...
class ProgramEnrollmentsApi extends base_1.BaseAPI {
     ...
     */
    v3ProgramEnrollmentsCreate(requestParameters, options) {
        return (0, exports.ProgramEnrollmentsApiFp)(this.configuration).v3ProgramEnrollmentsCreate(requestParameters.V3ProgramEnrollmentRequestRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Unenroll the user from this program.  Returns 204 No Content. Idempotent - returns 204 even if not currently enrolled. Returns 404 if the program does not exist.
     * @param {ProgramEnrollmentsApiV3ProgramEnrollmentsDestroyRequest} requestParameters Request parameters.
     ...
     */
    v3ProgramEnrollmentsDestroy(requestParameters, options) {
        return (0, exports.ProgramEnrollmentsApiFp)(this.configuration).v3ProgramEnrollmentsDestroy(requestParameters.program_id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * ViewSet for user program enrollments with v3 serializers.
     * @param {*} [options] Override http request option.
